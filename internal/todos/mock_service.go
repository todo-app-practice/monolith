...
//
//	mockgen -source=service.go -destination=mock_service.go -package=todos
//
...
func (m *MockService) GetAll(ctx context.Context, details PaginationDetails) ([]ToDoItem, PaginationMetadata, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) GetAll(ctx, details any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAll", reflect.TypeOf((*MockService)(nil).GetAll), ctx, details)
}
